...
This runtime package ships `catalog.json` and the generated zero-dependency bundle, but intentionally omits the development generator. Make catalog or bundle changes in the upstream Archify development repository, regenerate there, then refresh both artifacts here. Do not hand-edit `renderers/shared/generated-brand-marks.mjs`.
