...
These skills work in any agent via CLI. For auto-recall, auto-capture, and graph tools, check if your agent has a native Nowledge Mem connector — run the `status` skill or see https://mem.nowledge.co/docs/integrations
