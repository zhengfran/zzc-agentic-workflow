---
name: ljg-constraint
description: Map the constraints that define a domain, role, product, or debate.
...
写图前按骨架选择形式；需要模板时读取 [`references/ascii-structures.md`](references/ascii-structures.md)。不要为了复用模板扭曲分析结果。
